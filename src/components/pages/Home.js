        ...
        <div className='container mx-auto content-center text-slate-600 divide-y min-h-screen font-italiana min-w-screen'>
            ...
            <div className="grid grid-cols-1 text-center divide-y">
                ...
                <div className='p-6 text-2xl'>
                    ...
                    <p className='text-xl'>In-depth reports generated by throrough Market research of Retail based on Pricing, Sales, and Trends.</p>
                    <img className='mx-auto h-auto w-1/2' src={GirlFashion} alt="" />
                </div>
                <div className='p-6 text-2xl'>
                    <h2 className='font-bold'>Fashion Advice</h2>
                    <p className='text-xl'>You go, girl (or boy). I know what looks good.</p>
                    <img className='mx-auto h-auto w-1/2' src={GirlFashion} alt="" />
                </div>
            </div>
        </div>
